...
@mod_portalCliente_bp.route('/portalCliente')
@login_required
@fresh_login_required
@role_required(3)
def index_portal_cliente():
    return render_template('modulos/portalCliente/index-portal-cliente.html')

# Pagina inicial del modulo portal del cliente con el submodulo de pedidos
@mod_portalCliente_bp.route('/portalCliente/pedidos')
@login_required
@fresh_login_required
@role_required(3)
def portal_cliente_pedidos():
    return render_template('modulos/portalCliente/pedidos.html')

# Pagina inicial del modulo portal del cliente con el submodulo de historial de pedidos
@mod_portalCliente_bp.route('/portalCliente/historial-pedidos')
@login_required
@fresh_login_required
@role_required(3)
